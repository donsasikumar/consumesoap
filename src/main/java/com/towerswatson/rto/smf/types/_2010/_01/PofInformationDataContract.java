...
package com.towerswatson.rto.smf.types._2010._01;
...
/**
 * <p>Java class for PofInformationDataContract complex type.
 * 
...
@XmlType(name = "PofInformationDataContract", propOrder = {
    "pof",
    "errorCode",
    "errorMessage",
    "miDataCollection",
...
public class PofInformationDataContract {
    ...
    @XmlElementRef(name = "Pof", namespace = "http://towerswatson.com/rto/smf/types/2010/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pof;
    @XmlElementRef(name = "ErrorCode", namespace = "http://towerswatson.com/rto/smf/types/2010/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> errorCode;
    @XmlElementRef(name = "ErrorMessage", namespace = "http://towerswatson.com/rto/smf/types/2010/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> errorMessage;
    @XmlElementRef(name = "MIDataCollection", namespace = "http://towerswatson.com/rto/smf/types/2010/01", type = JAXBElement.class, required = false)
    protected JAXBElement<MIDataCollectionDataContract> miDataCollection;
    @XmlElementRef(name = "PofMetadata", namespace = "http://towerswatson.com/rto/smf/types/2010/01", type = JAXBElement.class, required = false)
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link MIDataCollectionDataContract }{@code >}
     *     
     */
     ...
     *     
     */
    public void setMIDataCollection(JAXBElement<MIDataCollectionDataContract> value) {
        this.miDataCollection = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link PofMetadataDataContract }{@code >}
     *     
     */
