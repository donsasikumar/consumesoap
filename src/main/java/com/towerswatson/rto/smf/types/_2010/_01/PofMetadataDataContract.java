...
public class PofMetadataDataContract {
    ...
    @XmlElementRef(name = "KeyName", namespace = "http://towerswatson.com/rto/smf/types/2010/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> keyName;
    @XmlElementRef(name = "KeyStartTime", namespace = "http://towerswatson.com/rto/smf/types/2010/01", type = JAXBElement.class, required = false)
