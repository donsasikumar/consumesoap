 ...
 * generated in the com.towerswatson.rto.smf.types._2010._01 package. 
...
public class ObjectFactory {
    ...
    private final static QName _PofMetadataDataContractKeyName_QNAME = new QName("http://towerswatson.com/rto/smf/types/2010/01", "KeyName");
    private final static QName _PofMetadataDataContractKeyStartTime_QNAME = new QName("http://towerswatson.com/rto/smf/types/2010/01", "KeyStartTime");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.towerswatson.rto.smf.types._2010._01
     * 
     */
    ...
    public JAXBElement<String> createPofMetadataDataContractKeyName(String value) {
        return new JAXBElement<String>(_PofMetadataDataContractKeyName_QNAME, String.class, PofMetadataDataContract.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createPofMetadataDataContractKeyStartTime(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_PofMetadataDataContractKeyStartTime_QNAME, XMLGregorianCalendar.class, PofMetadataDataContract.class, value);
    }
