 ...
 * generated in the com.towerswatson.rto.dpo.services._2010._01 package. 
...
public class ObjectFactory {
    ...
    private final static QName _PofRequestUsingKeyKeyName_QNAME = new QName("http://towerswatson.com/rto/dpo/services/2010/01", "KeyName");
    private final static QName _PofRequestUsingKeyKeyRequestTime_QNAME = new QName("http://towerswatson.com/rto/dpo/services/2010/01", "KeyRequestTime");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.towerswatson.rto.dpo.services._2010._01
     * 
     */
    ...
    public JAXBElement<PofrInformationCollectionDataContract> createPofRequestUsingKeyPofrCollection(PofrInformationCollectionDataContract value) {
        return new JAXBElement<PofrInformationCollectionDataContract>(_PofRequestPofrCollection_QNAME, PofrInformationCollectionDataContract.class, PofRequestUsingKey.class, value);
    }
    ...
    public JAXBElement<String> createPofRequestUsingKeyKeyName(String value) {
        return new JAXBElement<String>(_PofRequestUsingKeyKeyName_QNAME, String.class, PofRequestUsingKey.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createPofRequestUsingKeyKeyRequestTime(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_PofRequestUsingKeyKeyRequestTime_QNAME, XMLGregorianCalendar.class, PofRequestUsingKey.class, value);
    }
